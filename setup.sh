...
echo "  Ctrl+Alt+M      — cycle whisper model"
echo "  Ctrl+Alt+O      — toggle paste / type mode"
echo "  Ctrl+Alt+Return — toggle enter-after-insert"
echo "  Ctrl+Alt+S      — toggle settings overlay"
echo "  Ctrl+Alt+Z      — undo last dictation"
echo "  Ctrl+Alt+R      — reload action hooks"
echo "  Ctrl+Alt+X      — emergency stop"
echo ""
